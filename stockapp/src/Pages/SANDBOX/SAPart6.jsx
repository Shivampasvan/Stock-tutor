...
export default function SAPart6(){
    return(
    <div>
        ...
        {/* <Stack direction={['row','column']} > */}
            <Stack maxW={'4xl'} direction={{base:'column',lg:'row',xl:'row'}} margin={'auto'} spacing={30}>
                ...
                <VStack maxW={'xl'}>
                    ...
                    <Text>Build automated tests of your email sequences and include them in your testing suite. Verify each component of a message with Sandbox API.</Text>
                    <Button variant={'outline'} backgroundColor={'white'}>Learn More</Button>
                
                </VStack>
                <VStack maxW={'xl'}>
                    <Image src={'https://mailtrap.io/wp-content/uploads/2021/05/img__fake-email-environment.svg'} />
                    <Text as='b'>Fake SMTP</Text>
